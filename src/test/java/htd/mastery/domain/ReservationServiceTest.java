...
class ReservationServiceTest {
    ...
    @Test
    void shouldCalculateTotalStandardRateOnly() throws DataException {
        Host host = new Host();
        ...
        assertEquals(expected, service.calculateTotal(reservation, host));
    }

    @Test
    void shouldCalculateTotalWeekendRateOnly() throws DataException {
        Host host = new Host();
        host.setStandardRate(new BigDecimal("150.00"));
        host.setWeekendRate(new BigDecimal("250.00"));
    ...
    @Test
    void shouldCalculateTotalForStandardAndWeekendRate() throws DataException {
        Host host = new Host();
        host.setStandardRate(new BigDecimal("150.00"));
        host.setWeekendRate(new BigDecimal("250.00"));
